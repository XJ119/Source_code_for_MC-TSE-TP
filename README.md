...
trajectory_predict.py file is used to train the MC-TSE-TP model, the parameter "reduction" of loss function in the paper is set to reduction="mean", but the reduction="sum" can also used to train the MC-TSE-TP model;
